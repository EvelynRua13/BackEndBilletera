...
export const realizarRetiro = async (req, res) => {
    ...
    if (!fecha || !cuentaOrigen || monto === undefined || monto === null || isNaN(monto) || Number(monto) <= 0) {
    ...
    try {
        ...
        await connection.query('INSERT INTO Transacciones (cuenta_id, tipo, monto, fecha) VALUES (?, ?, ?, ?)', [cuentaOrigen, 'retiro', Number(monto), new Date()]);
